...
const COMMANDS = {
  ...
  whoami: {
    output: [ 
      { t: "comment", v: "# Farhan Abid — Full-Stack Developer" },
      { t: "gap" },
      { t: "kv", k: "Name",       v: "Farhan Abid" },
      { t: "kv", k: "Role",       v: "Full-Stack Web Developer · Backend-Focused" },
      { t: "kv", k: "Status",     v: "Open to Opportunities" },
      { t: "kv", k: "Internship", v: "Web Developer Intern @ Tripify India" },
  ...
  skills: {
    output: [
      ...
      { t: "kv", k: "Tools",      v: "Git · Postman · Vercel · Prisma" },
