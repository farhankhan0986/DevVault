...
description:
"RAG AI Chatbot is a production-grade, full-stack retrieval-augmented chatbot system. It allows users to ask natural language questions about their own data (e.g., website, docs, portfolio) using semantic search, chunked embeddings, and verifiable Groq or Cohere-powered AI answers. It features a responsive Next.js App Router UI, citations for every answer, and fast serverless API routes on Vercel.",
image: "/images/rag.png",
tech: [
"Next.js 14+ (App Router)",
"Groq AI (Llama 3 70B)/Cohere",
"React",
"Supabase (pgvector)",
"Node.js",
"Tailwind CSS",
...
status: "COMPLETED",
highlight: "Retrieval-Augmented Answers, Cited Context, Modern UI, Deploy on Vercel",
