      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="border-t border-border pt-16">
          ...
          <div className="space-y-6 duration-300 active:-translate-y-2 active:duration-300 active:transition-transform">
            <div className="group relative rounded-xl border border-border bg-card/60 p-6 backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:bg-card hover:shadow-[0_0_32px_rgba(99,102,241,0.25)]">
              ...
              <div className="relative space-y-3">
                ...
                <ul className="mt-3 space-y-1 text-sm text-muted">
                  <li className="flex gap-1 items-center">
                    <p className="text-[rgb(var(--primary))] text-2xl">•</p>
                    Built and maintained backend logic for a production travel booking
                    platform using Supabase Edge Functions and PostgreSQL.
                  </li>

                  <li className="flex gap-1 items-center">
                    <p className="text-[rgb(var(--primary))] text-2xl">•</p>
                    Integrated third-party travel APIs (including Amadeus) with real-time
                    data handling, rate limiting, retries, and environment-based switching.
                  </li>

                  <li className="flex gap-1 items-center">
                    <p className="text-[rgb(var(--primary))] text-2xl">•</p>
                    Developed AI-assisted tools to automate and optimize Google Ads
                    marketing workflows using performance data.
                  </li>

                  <li className="flex gap-1 items-center">
                    <p className="text-[rgb(var(--primary))] text-2xl">•</p>
                    Debugged and resolved live production issues using logs and API tracing,
          ...
          <div className="flex justify-start pl-6 my-5">
            <div className="h-15 w-px bg-border" />
          </div>
            ...
            <div className="group relative rounded-xl border border-border bg-card/60 p-6 backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:bg-card hover:shadow-[0_0_32px_rgba(99,102,241,0.25)]">
              ...
              <div className="relative space-y-3">
                ...
                <ul className="mt-3 space-y-1 text-sm text-muted">
                  <li className="flex gap-1 items-center">
                    <p className="text-[rgb(var(--primary))] text-2xl">•</p>
                    Built full-stack features using the MERN stack (MongoDB,
                    Express.js, React, Node.js).
                  </li>

                  <li className="flex gap-1 items-center">
                    <p className="text-[rgb(var(--primary))] text-2xl">•</p>
                    Developed responsive React components using hooks, routing,
                  ...
                  <li className="flex gap-1 items-center">
                    ...
                    including middleware and JWT-based authentication.
                  </li>

                  <li className="flex gap-1 items-center">
                    <p className="text-[rgb(var(--primary))] text-2xl">•</p>
                    Worked with MongoDB and Mongoose for CRUD operations and
