...
Backend: Node.js, Express.js, REST API Design, Supabase Edge Functions, FastAPI
...
Category: AI-Assisted Hiring & Candidate Evaluation Platform
Status: Full-stack production-ready application
Description: HireSight AI is an intelligent hiring platform designed to eliminate bias and inefficiency from the recruitment process. It allows organizations to create structured evaluation pipelines, score candidates across defined criteria, and make data-driven hiring decisions — all backed by a scalable backend.
Problem Solved: Traditional hiring is inconsistent and time-consuming. HireSight brings structure and objectivity to candidate assessment workflows.
Highlights:
  • Multi-role system supporting recruiters, hiring managers, and candidates
  • Structured scoring rubrics and evaluation workflows for each job role
  • Candidate data management with secure API-level access control
  • RESTful backend API with modular architecture supporting future AI scoring integration
  • MongoDB schema designed for flexible job and candidate data storage
  • Clean React.js frontend with real-time feedback and recruiter dashboard views
Tech: React.js, Node.js, Express.js, MongoDB, Mongoose ORM, REST APIs, JWT Authentication
GitHub: github.com/farhankhan0986/HireSight-AI
Engineering Depth: Demonstrates Farhan's ability to design multi-user systems with role separation, structured data pipelines, and scalable backend architecture.

---

PROJECT: IDVault
Category: Secure Identity & Document Management System
Status: Backend-focused, production-ready
Description: IDVault is a secure personal identity management platform that allows users to store, manage, and retrieve sensitive identity documents with enterprise-level authentication. Built with a security-first mindset, every layer of the system — from storage to session management — is hardened against common vulnerabilities.
Problem Solved: Sensitive personal data is often stored insecurely or in fragmented locations. IDVault centralizes and protects identity documents behind strong authentication.
Highlights:
  • Full authentication lifecycle: registration, login, JWT token issuance, and session expiry
  • Password security using bcrypt hashing with configurable salt rounds
  • Protected routes enforcing token validation on every sensitive endpoint
  • CRUD operations for identity documents with per-user data isolation
  • Middleware-based request validation and error handling pipeline
  • Clean MongoDB schema with user-document relational structure
Tech: Node.js, Express.js, MongoDB, Mongoose ORM, JWT, bcrypt, REST APIs
GitHub: github.com/farhankhan0986/IDVault
Engineering Depth: Showcases Farhan's mastery of backend security patterns — authentication flows, token management, and building APIs that enforce strict access control.

---

PROJECT: Sentinel Guard
Category: API Security Gateway, Rate Limiter & Traffic Firewall
Status: Middleware-first security infrastructure project
Description: Sentinel Guard is a backend-focused API security system built as a middleware layer that intercepts, monitors, and filters all incoming HTTP traffic before it reaches core application routes. It acts as a firewall and rate limiter — protecting APIs from abuse, DDoS-style traffic spikes, malicious requests, and unauthorized access attempts.
Problem Solved: Unprotected APIs are vulnerable to brute-force attacks, excessive traffic, and exploitation. Sentinel Guard provides a plug-in security layer for any Express.js backend.
Highlights:
  • Configurable rate limiting per IP and per endpoint with time-window based throttling
  • Real-time request logging with metadata capture (IP, route, timestamp, status)
  • Traffic filtering middleware that detects and rejects suspicious request patterns
  • Layered middleware architecture allowing modular enable/disable of security rules
  • Dashboard UI for monitoring live traffic, blocked requests, and usage analytics
  • MongoDB-backed request log persistence for audit trails
Tech: React.js, Node.js, Express.js, MongoDB, Mongoose ORM, Custom Middleware Architecture
GitHub: github.com/farhankhan0986/Sentinel-Guard
Engineering Depth: Demonstrates Farhan's deep understanding of backend security, middleware design patterns, and building infrastructure-level tools — skills directly applicable to platform engineering and backend roles.

---

PROJECT: DevVault
Category: AI-Powered Developer Portfolio Platform
Status: Live — currently deployed
Description: DevVault is Farhan's personal portfolio platform, built as a full-stack Next.js application with a deeply integrated AI assistant (AskFarhan). The site is designed not just as a showcase but as an interactive experience — recruiters and visitors can converse with an AI that answers questions about Farhan's skills, experience, and projects in real time.
Problem Solved: Static portfolios fail to engage recruiters who want quick, targeted answers. DevVault replaces passive browsing with active, AI-driven conversations.
Highlights:
  • AI chatbot (AskFarhan) powered by Groq API with a custom system prompt for recruiter-facing responses
  • Streaming AI responses for a real-time, low-latency chat experience
  • Framer Motion animations throughout for a premium, polished UI
  • Fully responsive layout built with Tailwind CSS 4
  • Dynamic project and experience sections with structured navigation
  • Built on Next.js 16 with React 19 for server-side rendering and optimal performance
Tech: Next.js 16, React 19, Tailwind CSS 4, Framer Motion, Groq AI API, JavaScript
Engineering Depth: Demonstrates Farhan's ability to combine modern frontend engineering with AI API integration — shipping a full-stack product that is both technically strong and visually compelling.
